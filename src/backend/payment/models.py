...
class ShippingAddress(models.Model):
    ...
    def __str__(self):
        return 'ShippingAddress object' + ' - ' + self.full_name
    ...
    def get_absolute_url(self):
        return reverse('payment_shipping')
...
class Order(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(check=models.Q(amount__gte=0), name='amount__gte_0')
        ]
...
class OrderItem(models.Model):
    ...
    @classmethod
    def get_total_quantity_product(cls, product):
